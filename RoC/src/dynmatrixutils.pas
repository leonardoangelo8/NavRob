...
uses
  Classes, SysUtils, dynmatrix, Grids {, main};
...
function  MloadSL(var SL : TStrings): TDMatrix;
...
function Mload(fname: string): TDMatrix;
var
  Trows,Tcols,r,c,lines,rxc: integer;
  F: TextFile;
  dum: double;
begin
  result := Mzeros(0,0);
...
////AJS  floor(dum); // para cortar com o warning
